...
- Accessible at [http://mastering-plone-project.localhost](http://mastering-plone-project.localhost) 🌐
...
- **backend**: Houses the API and Plone installation, utilizing pip instead of buildout, and includes a policy package named ploneconf.site.
