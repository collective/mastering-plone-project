...
2. Go to your repository at [collective/mastering-plone-project](https://github.com/collective/mastering-plone-project).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `ploneconf.example.com` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | ploneconf.example.com | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | ploneconf.example.com |
...
- [Backend Tests Workflow](https://github.com/collective/mastering-plone-project/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/collective/mastering-plone-project/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/collective/mastering-plone-project-backend`) and Frontend (`ghcr.io/collective/mastering-plone-project-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of ploneconf.example.com](https://github.com/collective/mastering-plone-project/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/ploneconf.example.com.yml` stack.
