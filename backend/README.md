...
Install ploneconf.site with uv.

```shell
uv add ploneconf.site
```
...
- [Issue tracker](https://github.com/collective/mastering-plone-project/issues)
- [Source code](https://github.com/collective/mastering-plone-project/)
...
1.  Clone this repository.
    ...
    cd mastering-plone-project/backend
    ```
